<div class="col-xs-12 col-md-12 col-lg-12 article-box" id="divSelectProduct">
    ...
    <!-- <div class="form-group">
        <div class="" style="display: inline-flex; width: 100%;">
            <select name="itemName" class="itemName form-control"></select>
        </div>
    </div> -->
    <div class="form-group">
    ...
    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" id="searchProduct">Search</button>
        ...
        <!-- } //primero en aparecer -->
    <!-- </form> -->
    <input name="locationId" id="locationId" type="hidden" value="{{$datosVenta->locationId}}"/>
